...
$stmt = $conn->prepare("SELECT owner_id, owner_name, phone_num, email, address, username FROM owner WHERE owner_id = :owner_id");
$stmt->execute([':owner_id' => $_SESSION['ownerID']]);
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="header-container container-fluid container-xl d-flex align-items-center justify-content-between">
            <a href="ownerhome.php" class="logo d-flex align-items-center me-auto me-xl-0">
                <h1 class="sitename">VetClinic</h1>
            </a>

            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="ownerhome.php" class="active">Home</a></li>
                    ...
                    <li class="dropdown"><a href="#"><span>MyPet</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="ownerpetlist.php">View Pet</a></li>
                            <li><a href="medhistory.php">Medical History Pet</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#"><span>Appointment</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href=".php">Upcoming Appointment</a></li>
                            <li><a href=".php">Appointment History</a></li>
                        </ul>
                    </li>
                     <li class="dropdown"><a href="#"><span>MyProfile</span> <i
                                class="bi bi-chevron-down toggle-dropdown"></i></a>
                        <ul>
                            <li><a href="ownerprofile.php">Update Profile</a></li>
                        </ul>
                    </li>
                </ul>
